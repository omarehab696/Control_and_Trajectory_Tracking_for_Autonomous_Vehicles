...
//           error_steer = 0;
          ...
          double desired_angle = angle_between_points(x_position, y_position, 
                                                      x_points[min_dist_idx], y_points[min_dist_idx]);
          double actual_angle = yaw;
          error_steer = desired_angle - actual_angle;
...
// Update the delta time with the previous command
    pid_throttle.UpdateDeltaTime(new_delta_time);
          ...
          **/
          ...
          double desired_speed = v_points[min_dist_idx];
